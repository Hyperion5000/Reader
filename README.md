...
**English summary:** Reader is a local Windows tool that converts PDF and DOCX documents to Markdown. It supports Russian OCR, scanned PDFs, mixed PDFs, and Word documents without sending files to cloud services.
